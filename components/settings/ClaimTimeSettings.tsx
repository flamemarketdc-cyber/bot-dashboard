    ...
    >
      ...
      <SettingsCard title="Default Configuration">
        <div className="space-y-4">
            <div>
                <label htmlFor="defaultMinutes" className="block text-sm font-medium text-zinc-300 mb-2">
                    Default Claim Time (in minutes)
                </label>
                <p className="text-xs text-zinc-400 mb-3">The base time a winner has to claim their prize if they have no special roles.</p>
                <input
                    type="number"
                    id="defaultMinutes"
                    name="defaultMinutes"
