  ...
  return (
    ...
    >
        ...
        <SettingsCard title="Whitelist">
            <label htmlFor="whitelistedRoles" className="block text-sm font-medium text-zinc-300 mb-2">
                Whitelisted Role IDs
            </label>
            <p className="text-xs text-zinc-400 mb-3">Users with these roles will bypass all auto-moderation filters.</p>
            <input
                type="text"
                id="whitelistedRoles"
